...
const Index = () => {
    ...
    const user_register = async (e) => {
        ...
        try {
            ...
            setLoader(false)
            localStorage.setItem('whiteboard', data.token)
            setState({
                name: '',
                email: '',
                password: ''
        ...
        <div className='bg-[#18191b] min-h-screen w-full'>
                ...
                <div className='w-[93%] m-auto py-3'>
                    <div className='flex justify-between items-center'>
                        <div className='w-[80px] h-[48px]'>
                            <h1 className='text-xl text-white'>Whiteboard</h1>
                        </div>
            ...
            <div className='w-full h-full justify-center items-center p-4'>
                <div className='py-[168px] flex justify-center items-center flex-col gap-6'>
                    ...
                    <span className='text-[#aca9a9] text-2xl font-medium'>Whiteboard makes it easy to create and share professional designs.</span>
                    <button onClick={() => {
                        setType('signup')
                        setShow(true)
